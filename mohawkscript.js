...
// Items array
const items = [
    {name: "bear", clan: "ohkwá:ri", image: "bear.png", audio: "Bear - Ohkwari.mp3"},
    {name: "deer", clan: "ohskennón:ton", image: "deer.png", audio: "Deer - Ohskennonton.mp3"},
    {name: "wolf", clan: "okwáho", image: "wolf.png", audio: "Wolf - Okwaho.mp3"},
    {name: "turtle", clan: "a'nó:wara", image: "turtle.png", audio: "Turtle - A'nowara.mp3"},
    {name: "beaver", clan: "tsyanì:to", image: "beaver.png", audio: "Beaver - Tsyanito.mp3"},
    {name: "heron", clan: "ohá:kwaront", image: "heron.png", audio: "Heron - Ohakwaront.mp3"},
    {name: "snipe", clan: "tawístawis", image: "sandpiper.png", audio: "Snipe - Tawistawis.mp3"},
    {name: "hawk", clan: "karhakón:ha", image: "hawk.png", audio: "Hawk - Karhakonha.mp3"},
    {name: "eel", clan: "tyawerón:ko", image: "eel.png", audio: "Eel - Tyaweronko.mp3"},
];
